...
@property (nonatomic, strong) YUFoldingSectionHeader *tmpHeader;
                    ...
                    sectionIndex:(NSInteger)sectionIndex
{
    ...
    if (sectionState == YUFoldingSectionStateShow) {
        if (self.arrowPosition == YUFoldingSectionHeaderArrowPositionRight) {
            ...
            self.arrowImageView.image = [UIImage imageNamed:@"bic_down"];
            self.contentView.backgroundColor = LOGINBACKCOLOR;
        ...
        if (self.arrowPosition == YUFoldingSectionHeaderArrowPositionRight) {
            self.arrowImageView.image = [UIImage imageNamed:@"ic_right"];
            self.contentView.backgroundColor = [UIColor whiteColor];
            self.titleLabel.textColor = TEXTCOLOR64;
...
//        _tmpHeader = self;
//    }else if (_tmpHeader != nil && _tmpHeader == self){
//        
//        self.sectionState = !self.sectionState;
//    }else if (_tmpHeader != self && _tmpHeader != nil){
//        
//        _tmpHeader.sectionState = 0;
//        self.sectionState = 1;
//        _tmpHeader = self;
//    }
...
//    CGRect descriptionRect = CGRectMake(YUFoldingMargin + YUFoldingIconWidth + labelWidth,  0, labelWidth, labelHeight);
    CGFloat labelWidth = MAINSCREEN.width/2 - 20;
    CGFloat labelHeight = 20.0;
    CGRect arrowRect = CGRectMake(MAINSCREEN.width - 35, 17, 16, 16);
    CGRect titleRect = CGRectMake(20, 15.0, labelWidth, labelHeight);
    CGRect descriptionRect = CGRectMake(YUFoldingMargin + YUFoldingIconWidth + labelWidth,  0, labelWidth, labelHeight);
