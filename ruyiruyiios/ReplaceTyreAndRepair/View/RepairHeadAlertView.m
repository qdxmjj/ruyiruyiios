...
- (UILabel *)alertLabel{
    ...
    if (_alertLabel == nil) {
        ...
        _alertLabel.font = [UIFont fontWithName:TEXTFONT size:10.0];
        ...
        CGSize labelSize = [_alertLabel.text boundingRectWithSize:CGSizeMake(MAINSCREEN.width - 6, MAINSCREEN.height) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
        [_alertLabel setFrame:CGRectMake(5, 5, labelSize.width, labelSize.height)];
    }
    return _alertLabel;
}
