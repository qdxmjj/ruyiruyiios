...
@interface FMDBUserInfo : NSObject
...
@property(nonatomic, strong)NSString *deletedFlag;
@property(nonatomic, strong)NSString *deletedTime;
@property(nonatomic, strong)NSString *email;
@property(nonatomic, strong)NSNumber *firstAddCar;
...
@property(nonatomic, strong)NSString *qqInfoId;
