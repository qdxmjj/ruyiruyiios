...
- (UIScrollView *)mainScrollV{
    ...
    if (_mainScrollV == nil) {
        ...
        _mainScrollV.frame = self.view.bounds;
...
- (UIButton *)welcomeBtn{
    ...
    if (_welcomeBtn == nil) {
        ...
        _welcomeBtn.layer.cornerRadius = 16;
        _welcomeBtn.layer.masksToBounds = YES;
        _welcomeBtn.titleLabel.font = [UIFont fontWithName:TEXTFONT size:18.0];
        [_welcomeBtn setBackgroundColor:LOGINBACKCOLOR forState:UIControlStateNormal];
        [_welcomeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [_welcomeBtn setTitle:@"开启小马驾驾" forState:UIControlStateNormal];
